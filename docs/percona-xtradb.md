---
title: The Percona XtraDB storage engine
description: Percona XtraDB is an enhanced version of the *InnoDB* storage engine,
  designed to better scale on modern hardware.
slug: percona-xtradb
stability: stable
