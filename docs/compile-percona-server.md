---
title: Compile Percona Server for MySQL from source
description: The following instructions install Percona Server for MySQL {{vers}}.
slug: compile-percona-server
stability: stable
