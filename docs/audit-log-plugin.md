...
* [Percona Server for MySQL 8.0.15-6](https://docs.percona.com/percona-server/8.0/release-notes/Percona-Server-8.0.15-6.html): The Audit_log_buffer_size_overflow variable was implemented.
