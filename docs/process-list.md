---
title: Process list
description: This page describes Percona changes to both the standard *MySQL* `SHOW
  PROCESSLIST` command and the standard *MySQL* `INFORMATION_SCHEMA` table `PROCESSLIST`.
slug: process-list
stability: stable
