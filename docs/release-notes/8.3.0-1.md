# Percona Server for MySQL 8.3.0-1 (2024-0-0)
...
This release merges the MySQL 8.3 code base. Improvements and bug fixes introduced by Oracle for MySQL 8.3 and included in Percona Server for MySQL are the following:
