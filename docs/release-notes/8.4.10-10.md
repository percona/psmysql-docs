# Percona Server for MySQL 8.4.10-10 (2026-07-)
...
* [PS-10070](https://perconadev.atlassian.net/browse/PS-10070): Updates the existing component to use the new KMIP library.
