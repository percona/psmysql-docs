...
* Improves the `audit_log_filter_set_user` behavior to allow wildcards in hostname.
...
* [PS-9024](https://perconadev.atlassian.net/browse/PS-9024): Improves the `audit_log_filter_set_user` behavior to allow wildcards in hostname.
