---
title: Defaults and tuning guidance for {{vers}}
description: MySQL {{vers}} updates several server defaults to align with modern CPUs,
  memory sizes, and SSD/NVMe storage. An in-place upgrade that blindly reuses an 8.0-era
  `my.
slug: 8.4-defaults-and-tuning
since: '8.4'
until: null
stability: stable
