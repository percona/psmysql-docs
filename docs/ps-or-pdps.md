...
To read more about Percona Distribution for MySQL, see the [Percona Distribution for MySQL 8.0 :octicons-link-external-16:](https://docs.percona.com/percona-distribution-for-mysql/8.0/) documentation.
...
* [Install Percona Server for MySQL 8.0](installation.md)

* [Install Percona Distribution for MySQL 8.0 :octicons-link-external-16:](https://docs.percona.com/percona-distribution-for-mysql/8.0/installing.html)
