...
| percona-server-client-plugins-debuginfo | Debug symbols for `percona-server-client-plugins`, used for troubleshooting client plugin issues.|
...
| percona-server-js-debuginfo | Debug symbols for `percona-server-js`, used for troubleshooting server-side JavaScript support.|
...
| percona-server-shared-compat | Compatibility shared libraries for applications built against older Percona Server / MySQL client library versions.|
