...
!!! important
    ...
    An in-place upgrade is not recommended. Use a [replication upgrade :octicons-link-external-16:](https://docs.percona.com/percona-xtradb-cluster/8.0/upgrade-guide.html).
