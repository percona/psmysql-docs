...
replication replica using *Percona XtraBackup* see [this how-to :octicons-link-external-16:](https://docs.percona.com/percona-xtrabackup/{{vers}}/set-up-replication.html)).
