...
Use the [UNINSTALL PLUGIN :octicons-link-external-16:](https://dev.mysql.com/doc/refman/8.0/en/uninstall-plugin.html) statement and the [DROP FUNCTION :octicons-link-external-16:](https://dev.mysql.com/doc/refman/8.0/en/drop-function.html) statement to disable and uninstall the plugin and then remove the functions. 
