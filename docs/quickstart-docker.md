...
To run the Docker ARM64 version of Percona Server for MySQL, use the `8.4.0-aarch64` tag instead of `8.4.0`.
...
??? example "Expected output"
    ...
    Status: Downloaded newer image for percona/percona-server:8.4
