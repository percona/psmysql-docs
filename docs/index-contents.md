...
- [Non-interactive DNF installation for Percona Server for MySQL {{vers}}](yum-noninteractive-install.md)
- [Optional steps after repository install for Percona Server for MySQL {{vers}}](optional-after-install.md)
...
- [Non-interactive APT installation for Percona Server for MySQL {{vers}}](apt-noninteractive-install.md)
- [Optional steps after repository install for Percona Server for MySQL {{vers}}](optional-after-install.md)
