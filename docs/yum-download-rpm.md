...
Using `Wget`, the following command downloads a specific version of the Percona Server for Red Hat Enterprise Linux 8 from the Percona website. 
...
* `h` - display hash marks (`#`) as the package is being installed to indicate progress
